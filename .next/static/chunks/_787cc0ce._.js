...
"[project]/app/genre/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function GenrePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GenrePage.useEffect": ()=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8bd0c73f$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$firebaseConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], {
                "GenrePage.useEffect.unsubscribe": (user)=>{
                    if (user) setUserId(user.uid);
                }
            }["GenrePage.useEffect.unsubscribe"]);
            return ({
                "GenrePage.useEffect": ()=>unsubscribe()
            })["GenrePage.useEffect"];
        }
    ...
    const fetchMoviesByGenre = async ()=>{
        ...
        setLoading(true);
        try {
            const queries = await Promise.all(selectedGenres.map((genre)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${apikey}&s=${genre}`)));
            const results = (await Promise.all(queries.map((res)=>res.data.Search || []).flat().map(async (movie)=>{
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${apikey}&i=${movie.imdbID}`);
                return data;
          ...
          `
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex flex-wrap gap-2 mb-6 max-w-5xl",
                        children: [
                            allGenres.map((genre)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: ()=>toggleGenre(genre),
                                    className: `text-xs px-3 py-1 rounded-full border whitespace-nowrap ${selectedGenres.includes(genre) ? "bg-white text-black border-white" : "bg-white/10 text-white border-white/30 hover:bg-white/20"} transition`,
                                    children: genre
                                }, genre, false, {
                                    fileName: "[project]/app/genre/page.tsx",
                                    lineNumber: 184,
                    ...
                    movies.length === 0 && !loading && selectedGenres.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-center text-white/70 mt-12 text-lg",
...
_s(GenrePage, "rgtAaLAvxdtR/dwlYzzdJgHnGnU=", false, function() {
    return [
...
_c = GenrePage;
var _c;
__turbopack_context__.k.register(_c, "GenrePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_787cc0ce._.js.map